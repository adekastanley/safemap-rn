	...
	return (
		<View style={styles.container}>
          ...
          /> */}
				...
				<Animated.Text style={[styles.text, opacityText]}>Type 1</Animated.Text>
			</Animated.View>
			<Animated.View
          ...
          /> */}
				...
				<Animated.Text style={[styles.text, opacityText]}>Type 2</Animated.Text>
			</Animated.View>
			<Animated.View
			...
			>
				...
				<Animated.Text style={[styles.text, opacityText]}>Type 3</Animated.Text>
			</Animated.View>
			<Pressable
